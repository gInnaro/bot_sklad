...
def sendslk():
  ...
  msg['Subject'] = 'ЗАЯВКА НА ВЪЕЗД СМАРТЛАЙФКЕА.docx'                   # Тема сообщения

  body = ""
  msg.attach(MIMEText(body, 'plain'))                 # Добавляем в сообщение текст
  filepath="ЗАЯВКА НА ВЪЕЗД СМАРТЛАЙФКЕА.docx"                   # Имя файла в абсолютном или относительном формате
